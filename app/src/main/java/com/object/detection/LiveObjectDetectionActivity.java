...
import com.object.detection.camera.CameraSource;
import com.object.detection.camera.CameraSourcePreview;
import com.object.detection.camera.GraphicOverlay;
import com.object.detection.camera.WorkflowModel;
import com.object.detection.camera.WorkflowModel.WorkflowState;
import com.object.detection.objectdetection.MultiObjectProcessor;
import com.object.detection.objectdetection.ProminentObjectProcessor;
import com.object.detection.imagesearch.BottomSheetScrimView;
import com.object.detection.imagesearch.Product;
import com.object.detection.imagesearch.ProductAdapter;
import com.object.detection.imagesearch.SearchEngine;
import com.object.detection.imagesearch.SearchedObject;
import com.object.detection.settings.PreferenceUtils;
import com.object.detection.settings.SettingsActivity;
...
int cc=1;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    new Handler().postDelayed(new Runnable() {
      @Override
      public void run() {
        t1.speak("Welcome to object detection, Hold your phone to scan", TextToSpeech.QUEUE_FLUSH, null,String.valueOf(cc));
        cc++;
    ...
    workflowModel.searchedObject.observe(
        ...
        searchedObject -> {
          if (searchedObject != null) {
            ...
            String text=productList.get(0).getTitle();
            text=productList.size()>1?"This can be a "+productList.get(0).getTitle()+" or,"+productList.get(1).getTitle()+" or,"+productList.get(2).getTitle():productList.get(0).getTitle();
            t1.speak(text, TextToSpeech.QUEUE_FLUSH, null,String.valueOf(cc));
            cc++;
